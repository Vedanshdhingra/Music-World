  ...
  <div id="page">
    ...
    <div class="width75 floatRight">
      <div class="gradient">
		...
		<tr align='center' height='65px'><td>All Songs Zipfile 120Kbps &nbsp;&nbsp;&nbsp;&nbsp;<a href='<%=l128 %>' download>Download here</a></td></tr>
		<tr align='center' height='65px'><td>All Songs Zipfile 320Kbps &nbsp;&nbsp;&nbsp;&nbsp;<a href='<%=l320 %>' download>Download here</a></td></tr>
		</table>	
			<%	
			}
		}
