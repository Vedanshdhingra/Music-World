		...
		for (var i=0; i<document.srch.type.length; i++)
   		{
      		...
      		{
      			rad_val = document.srch.type[i].value;
				break;
      		}
		}	
		var url = 'srchdata.jsp?value=' + encodeURIComponent(tex) + '&type=' + rad_val;
		var xmlhttp;
...
<%@ include file="menu/header.jsp" %>
  <%@ include file="menu/smainmenu.jsp" %>
  <div id="page">
	<%@ include file="menu/sidemenu.jsp" %>	
    <div class="width75 floatRight">
      <div class="gradient">
     <h1>Search Movie Song</h1>
		...
		<form name="srch"  id="formID" method="get" action="" onSubmit="loadXMLDoc(); return false;">
